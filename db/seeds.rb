...
attirs = ['Offer','Offer','Offer','Offer','Offer','Offer', 'Rejected','Rejected', 
  'Next Round','Next Round','Next Round','Next Round', 'Unknown', 'Unknown', 'Unknown']
...
lengths = ["Less Than 30 Min", '30 Min', '1 Hr', "1.5 Hrs", "2+ Hrs"]

questions = ['We are such stuff as dreams are made on, and our little life, is rounded with a sleep',
...
descriptions = ["Write a program that prints ‘Hello World’ to the screen.",
...
Pin.create(position: positions.sample, company: companies.sample, date: days.sample.to_s + ' ' + month.sample + year,
	...
	length: lengths.sample, description: descriptions.sample, user_id: -1, position_type: position_types.sample, genre: genres.sample)
}
